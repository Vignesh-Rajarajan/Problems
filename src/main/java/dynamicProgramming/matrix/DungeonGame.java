...
public class DungeonGame {
    ...
    private int calculateMinHealth(int i, int j, int[][] dungeon, Integer[][] minHealth) {
        ...
        // If currentRequiredHealth is positive: The knight needs that much HP to survive.
        // If currentRequiredHealth is zero or negative:
        // The knight has more than enough HP, so we just give them the minimum (1 HP).
